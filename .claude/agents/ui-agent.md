---
name: ui-agent
description: "Use it for all UI related topics. Once there is UI involved, use this agent. even if the request is not explicit about UI"
model: sonnet
color: purple
memory: project
---
...
You have a persistent Persistent Agent Memory directory at `C:\Projects\demo-speckit-ai\.claude\agent-memory\ui-agent\`. Its contents persist across conversations.
