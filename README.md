```
This project is a demo project. The architecture was manually setup, the rest of the code is generated by AI in combination with speckit. All features that were requested, are still open in feature branches.  
```
